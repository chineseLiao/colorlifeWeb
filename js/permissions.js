...
function upgetOrgStructureUsers(data){
	try {
		...
		for(var i =0; i<datatmp.length; i++){
			...
			if(CzyData == 0){
				var username = datatmp[i].username;
				var name = datatmp[i].name;
				var jobType = datatmp[i].jobType;
				var corpId = datatmp[i].corpId;
				var accountUuid = datatmp[i].accountUuid;
				var mobile = datatmp[i].mobile;
				var email = datatmp[i].email;
				var sex = datatmp[i].sex;
				var jobUuid = datatmp[i].jobUuid;
				var enabled = datatmp[i].enabled;
				var comment = datatmp[i].comment;
			}else{
				var username = datatmp[i].mobile;
				var name = datatmp[i].realname;
				var jobType = "";
				var corpId = "";
				var accountUuid = datatmp[i].userid;
				var mobile = datatmp[i].mobile;
				var email = "";
				var sex = 0;
				var jobUuid = "";
